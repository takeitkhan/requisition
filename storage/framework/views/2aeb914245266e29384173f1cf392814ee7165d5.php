    ...
    <div class="card tile is-child">
        ...
        <div class="card-content">
            <div class="card-data">
                ...
                <?php endif; ?>
                <?php echo e(Form::open(array('url' => route('taskproof.store'), 'method' => 'POST', 'value' => 'PATCH', 'id' => 'add_route', 'files' => true, 'autocomplete' => 'off'))); ?>
...
<script>
    $(document).ready(function() {
        function upload(arg, id, id2){
            ...
            $('span.remove'+id2).empty().append('<span class="remove remove'+id2+'">Remove image</span>');
        }
...
<?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/task/src/views/taskaction/task_proof_form.blade.php ENDPATH**/ ?>