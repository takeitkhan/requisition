    ...
    if (request()->get('daterange')) {
        ...
        $resourceUsedArchive = DB::select("
                          SELECT * FROM (
                              ...
                              UNION
                                  SELECT id AS resource_id, NULL AS used   FROM users WHERE users.role = 2 AND users.employee_status  NOT IN ( 'Terminated', 'Left Job', 'Long Leave', 'On Hold')
            ...
            <div class="card tile is-child xquick_view">
                <div class="card-content">
                    <div class="column is-12 mb-4">
                        <form method="get" action="<?php echo e(route('archive.resource.usage',)); ?>">
                            <?php echo csrf_field(); ?>

                            <div class="field has-addons">
                                <a href="<?php echo e(route('archive.resource.usage.excel')); ?>?daterange=<?php echo e(request()->get('daterange') ?? NULL); ?>"
                        ...
                        <div class="columns">
                            ...
                            <div class="column is-8 mx-auto">
                                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                                    <tr>
                                        <th colspan="6">Used</th>
                                    </tr>
                                    <tr>
                                        <th class="has-background-primary-dark">Name</th>
                                        <th class="has-background-primary-dark">Designation</th>
                                        <th class="has-background-primary-dark">Department</th>
                                        <th class="has-background-primary-dark" style="width: 90px;">Site Head</th>
                                        <th class="has-background-primary-dark" style="width: 30px;">Resource</th>
                                        <th class="has-background-primary-dark" style="width: 30px;">Total</th>
                                    </tr>
                                    <?php
                                    ...
                                    <?php $__currentLoopData = $used; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="">
                                                <a target="_blank"
                                                   href="<?php echo e(route('hidtory.user', $data['id'])); ?>"><?php echo e($data['name']); ?></a>
                                            </td>
                                            <td><?php echo e($data['designationName'] ?? NULL); ?></td>
                                            <td>
                                                <?php echo e($data['department'] ?? NULL); ?>

                                            </td>
                                            <td style="width: 90px;">
                                                <?php echo e($data['siteHead']  ?? NULL); ?>

                                            </td>

                                            <td style="width: 30px;">
                                                <?php echo e($data['Resource']  ?? NULL); ?>

                                            </td>
                                            <td style="width: 30px;">
                                                <?php echo e($data['count']  ?? NULL); ?>
                            ...
                            <div class="column is-4 mx-auto">
                                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                                    <tr>
                                        <th colspan="3">Not Used</th>
                                    </tr>
                                    <tr>
                                        <th class="has-background-danger">Name</th>
                                        <th class="has-background-danger">Designation</th>
                                        <th class="has-background-danger">Department</th>
                                    </tr>
                                    ...
                                    <?php $__currentLoopData = $nonUsed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $joinDate = $data['join_date']; ?>
                                        <?php if( $joinDate < $enddate ): ?>
                                            <tr>
                                                <td style="">
                                                    <a target="_blank"
                                                       href="<?php echo e(route('hidtory.user', $data['id'])); ?>"><?php echo e($data['name']); ?></a>
                                                </td>
                                                <td><?php echo e($data['designationName']); ?></td>
                                                <td>
                                                    <?php echo e($data['department'] ?? NULL); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/task/src/views/archive_resource_usage.blade.php ENDPATH**/ ?>