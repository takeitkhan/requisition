...
<?php $__env->startSection('column_left'); ?>
        ...
        <div class="card-content">
            <div class="card-data">
                <div class="columns">
                    ...
                    <div class="column"><?php echo e($vehicle->name); ?></div>
                </div>
                <div class="columns">
                    <div class="column is-2">Vehicle size</div>
                    <div class="column is-1">:</div>
                    <div class="column"><?php echo e($vehicle->size); ?></div>
                </div>
                <div class="columns">
                    <div class="column is-2">Probably Cost</div>
                    <div class="column is-1">:</div>
                    <div class="column"><?php echo e($vehicle->probably_cost); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card tile is-child" style="margin-top: 15px !important;">
        <header class="card-header">
            ...
            <?php echo e(Form::open(array('url' => route('vehicles.show', $vehicle->id), 'method' => 'GET', 'value' => 'PATCH', 'id' => 'tasks_advanced_search', 'class' => 'dateFilter', 'autocomplete' => 'off'))); ?>



            <div class="columns">
                <div class="column">
                    <a href="<?php echo e(route('download_excel_vehicle')); ?>?id=<?php echo e($vehicle->id); ?>&daterange=<?php echo e(request()->get('daterange') ??  date('Y-m-d', strtotime(date('Y-m-d'). ' - 30 days')). ' - ' . date('Y-m-d')); ?>"
                        ...
                        <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td title="Vehicle Rent">
                                        ...
                                        <?php echo e($in_total[] = $vehicle->vehicle_rent); ?>

                                </td>
                                <td title="Vehicle Note">
                                    <?php echo e($vehicle->vehicle_note); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/vehicle/src/views/show.blade.php ENDPATH**/ ?>