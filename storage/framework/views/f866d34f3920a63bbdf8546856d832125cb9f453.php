        ...
        <div class="card-data">
            <div class="columns">
                <div class="column">
                    ...
                    <?php if(auth()->user()->isResource(auth()->user()->id) && rData('bill_prepared_by_resource') == 'Yes'): ?>
                        <?php
                    ...
                    <?php if(auth()->user()->isManager(auth()->user()->id) && rData('bill_edited_by_manager') == 'Yes'): ?>
                        <?php
                            echo Tritiyo\Task\Helpers\RequisitionBillHelper::requisitionBillActionHelper([
                    ...
                    <?php if(auth()->user()->isCFO(auth()->user()->id) && rData('bill_edited_by_cfo') == 'Yes'): ?>
                        <?php
                            echo Tritiyo\Task\Helpers\RequisitionBillHelper::requisitionBillActionHelper([
                    ...
                    <?php if(auth()->user()->isAccountant(auth()->user()->id) && rData('bill_edited_by_accountant') == 'Yes'): ?>
                        <?php
                            echo Tritiyo\Task\Helpers\RequisitionBillHelper::requisitionBillActionHelper([
                ...
                <div class="column">
                    ...
                    <div class="statusSuccessMessage">
                        <?php echo e(\Tritiyo\Task\Models\TaskStatus::where('task_id', $task->id)->orderBy('id', 'desc')->first()->message); ?>
...
<?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/task/src/views/taskrequisitionbill/bill_accept_decline.blade.php ENDPATH**/ ?>