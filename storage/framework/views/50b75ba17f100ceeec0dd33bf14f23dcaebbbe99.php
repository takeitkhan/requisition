            ...
            <div class="columns">
                <div class="column">
                    ...
                    <?php if(auth()->user()->isManager(auth()->user()->id)): ?>
                        <?php echo $__env->make('task::taskaction.ready_for_assign_to_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->user()->isApprover(auth()->user()->id)): ?>
                           ...
                           ?>
                  				...
                  				<?php else: ?>
                        			<?php echo $__env->make('task::taskaction.task_approver_accept_decline', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/task/src/views/taskaction/accept_decline.blade.php ENDPATH**/ ?>