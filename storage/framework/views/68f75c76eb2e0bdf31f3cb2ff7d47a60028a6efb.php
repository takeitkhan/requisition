...
<?php $__env->startSection('column_left'); ?>
    <article class="panel is-primary">
        ...
        <p class="panel-tabs">
            ...
            <a href="<?php echo e(route('projects.range', $project->id)); ?>" class="is-active">
                ...
                <header class="card-header  accordion-header stoggle">
                    <p class="card-header-title">
                        ...
                        <a class="ml-3 is-size-7 has-text-link-dark"
                           href="<?php echo e(route('projects.range', $project->id)); ?>?range_key=<?php echo e($rangeKey); ?>">Click Here</a>
                    </p>
                </header>

                <div class="accordion-body">
                    <?php if(request()->get('range_key') == $rangeKey): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/project/src/views/range.blade.php ENDPATH**/ ?>