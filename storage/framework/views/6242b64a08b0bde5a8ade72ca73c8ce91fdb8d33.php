        ...
        <div class="column is-6 mx-auto">
            <div class="card tile is-child xquick_view">
                ...
                <div class="card-content">
                    <div class="card-data">
                        <form method="post" action="<?php echo e(route('excel.manager.site.report.download')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/site/src/views/excel/manager_site_report.blade.php ENDPATH**/ ?>