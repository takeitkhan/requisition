                        ...
                        <?php $__currentLoopData = $moves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $move): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    BDT. <?php echo e($mApproveReq [] = $requisition); ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                    BDT. <?php echo e($mSubmitBill [] = $submitbill); ?>

                                </td>
                                <td>
                                    BDT. <?php echo e($mApproveBill []= Tritiyo\Task\Helpers\SiteHeadTotal::totalAmountRequisionBill('beba_amount' ,$move->task_id)/$taskSite); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mts\requisition\vendor\tritiyo\site\src/views/show.blade.php ENDPATH**/ ?>