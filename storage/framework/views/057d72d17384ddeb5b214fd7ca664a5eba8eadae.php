        ...
        <div class="column is-6 mx-auto">
            <div class="card tile is-child xquick_view">
                ...
                <div class="card-content">
                    <div class="card-data">
                        <form method="post" action="<?php echo e(route('download_excel_bill_accountant')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/mtsbd.net/public_html/employee/vendor/tritiyo/task/src/views/excel/bill_by_accountant.blade.php ENDPATH**/ ?>