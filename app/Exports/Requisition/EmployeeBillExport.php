...
class EmployeeBillExport implements FromCollection, WithHeadings, ShouldAutoSize, WithColumnFormatting
{
    private $date;
    private $project_id;

    /**
     * EmployeeBillExport constructor.
     * @param $date
     */
...
//          									->where('bill_approved_by_accountant', 'Yes')
//                                            ->get()->toArray();
        ...
        foreach ($getData as $data) {
            $total = new \Tritiyo\Task\Helpers\SiteHeadTotal('bill_edited_by_accountant', $data['task_id']);
